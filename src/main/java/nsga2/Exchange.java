...
//		 if(a.selectTheUAVForTheNode[i]>=son1.uav.size())
//		 {
//			for(int j1=0;j1<a.selectTheUAVForTheNode.length;j1++)
//			{
//				System.out.print(a.selectTheUAVForTheNode[j1]+" ");
//			}
//			System.out.println("前半部分");
//			System.out.println(a.uav.size()-1);
//		 }
