...
public class GenerateNextPopulation {
	...
	public static Population generateNextPopulation(Population pop, Map map, int iteratorTimes) throws CloneNotSupportedException {
		...
		if (iterator.equals("variation2")) {
			...
			x2 = 0;
			x3 = 1;
		} else if (iterator.equals("variation2+variation4")) {
			x1 = 0;
			x2 = (float) 0.4;
			x3 = (float) 1;
		} else if (iterator.equals("variation2+variation3+variation4")) {
			x1 = 0;
			x2 = (float) 0.3;
			x3 = (float) 0.7;
			x4 = (float) 0.95;
		} else if (iterator.equals("ReduceTime")) {
			x1 = 0;
			x2 = 0;
			x3 = 0;
			x4 = 0;
		} else if (iterator.equals("variation4")) {
			x1 = 0;
			x2 = 1;
		}
